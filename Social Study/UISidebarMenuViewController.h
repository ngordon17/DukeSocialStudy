...
@class UISidebarMenuViewController;
@protocol UISidebarMenuViewControllerDelegate;
...
typedef NS_ENUM(NSInteger, UISidebarMenuToggleAnimationType) {
    UISidebarMenuToggleAnimationTypeSpring,    // <- produces a spring based animation
    UISidebarMenuToggleAnimationTypeEaseOut,   // <- produces an ease out curve animation
};


@interface UISidebarMenuViewController : UIViewController
...
// Use this on iOS7 when you add an instance of RevealViewController as a child of a UINavigationController (or another UISidebarMenuViewController)
...
// Animation type, default is UISidebarMenuToggleAnimationTypeSpring
@property (nonatomic) UISidebarMenuToggleAnimationType toggleAnimationType;

// When animation type is UISidebarMenuToggleAnimationTypeSpring determines the damping ratio, default is 1
...
// Delegate
@property (nonatomic,weak) id<UISidebarMenuViewControllerDelegate> delegate;

@end


#pragma mark - UISidebarMenuViewControllerDelegate Protocol

typedef enum {
    UISidebarMenuControllerOperationNone,
    UISidebarMenuControllerOperationReplaceRearController,
    UISidebarMenuControllerOperationReplaceFrontController,
    UISidebarMenuControllerOperationReplaceRightController,
    
} UISidebarMenuControllerOperation;


@protocol UISidebarMenuViewControllerDelegate<NSObject>

@optional

// The following delegate methods will be called before and after the front view moves to a position
- (void)revealController:(UISidebarMenuViewController *)revealController willMoveToPosition:(FrontViewPosition)position;
- (void)revealController:(UISidebarMenuViewController *)revealController didMoveToPosition:(FrontViewPosition)position;

// This will be called inside the reveal animation, thus you can use it to place your own code that will be animated in sync
- (void)revealController:(UISidebarMenuViewController *)revealController animateToPosition:(FrontViewPosition)position;

// Implement this to return NO when you want the pan gesture recognizer to be ignored
- (BOOL)revealControllerPanGestureShouldBegin:(UISidebarMenuViewController *)revealController;

// Implement this to return NO when you want the tap gesture recognizer to be ignored
- (BOOL)revealControllerTapGestureShouldBegin:(UISidebarMenuViewController *)revealController;

// Implement this to return YES if you want other gesture recognizer to share touch events with the pan gesture
- (BOOL)revealController:(UISidebarMenuViewController *)revealController
...
- (void)revealControllerPanGestureBegan:(UISidebarMenuViewController *)revealController;
- (void)revealControllerPanGestureEnded:(UISidebarMenuViewController *)revealController;
...
- (void)revealController:(UISidebarMenuViewController *)revealController panGestureBeganFromLocation:(CGFloat)location progress:(CGFloat)progress overProgress:(CGFloat)overProgress;
- (void)revealController:(UISidebarMenuViewController *)revealController panGestureMovedToLocation:(CGFloat)location progress:(CGFloat)progress overProgress:(CGFloat)overProgress;
- (void)revealController:(UISidebarMenuViewController *)revealController panGestureEndedToLocation:(CGFloat)location progress:(CGFloat)progress overProgress:(CGFloat)overProgress;

// Notification of child controller replacement
- (void)revealController:(UISidebarMenuViewController *)revealController willAddViewController:(UIViewController *)viewController
            forOperation:(UISidebarMenuControllerOperation)operation animated:(BOOL)animated;
- (void)revealController:(UISidebarMenuViewController *)revealController didAddViewController:(UIViewController *)viewController
            forOperation:(UISidebarMenuControllerOperation)operation animated:(BOOL)animated;
...
- (id<UIViewControllerAnimatedTransitioning>)revealController:(UISidebarMenuViewController *)revealController
                              animationControllerForOperation:(UISidebarMenuControllerOperation)operation fromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC;

// DEPRECATED - The following delegate methods will be removed some time in the future
- (void)revealController:(UISidebarMenuViewController *)revealController panGestureBeganFromLocation:(CGFloat)location progress:(CGFloat)progress; // (DEPRECATED)
- (void)revealController:(UISidebarMenuViewController *)revealController panGestureMovedToLocation:(CGFloat)location progress:(CGFloat)progress; // (DEPRECATED)
- (void)revealController:(UISidebarMenuViewController *)revealController panGestureEndedToLocation:(CGFloat)location progress:(CGFloat)progress; // (DEPRECATED)
@end


#pragma mark - UIViewController(UISidebarMenuViewController) Category

// A category of UIViewController to let childViewControllers easily access their parent UISidebarMenuViewController
@interface UIViewController(UISidebarMenuViewController)
...
@interface UISidebarMenuViewControllerSegueSetController : UIStoryboardSegue
@end

// Use this to push a view controller
@interface UISidebarMenuViewControllerSeguePushController : UIStoryboardSegue
@end
