//
//  UISidebarMenuViewController.h
//  Social Study
//
//  Created by Nicholas Gordon on 8/29/14.
...
#pragma mark - UISidebarMenuView Class

@interface UISidebarMenuView: UIView {
    __weak UISidebarMenuViewController *_c;
}
...
@interface UISidebarMenuViewController()
...
@implementation UISidebarMenuView
...
- (id)initWithFrame:(CGRect)frame controller:(UISidebarMenuViewController*)controller {
...
- (CGFloat)_adjustedDragLocationForLocation:(CGFloat)x {
    ...
    if (x <= revealWidth) {
        ...
        result = revealWidth + (x-revealWidth)/2;   // slow down translation by halve the movement.
    } else {
...
@implementation SWContextTransitionObject {
    __weak UISidebarMenuViewController *_revealVC;
    UIView *_view;
...
- (id)initWithRevealController:(UISidebarMenuViewController*)revealVC containerView:(UIView*)view fromVC:(UIViewController*)fromVC toVC:(UIViewController*)toVC completion:(void (^)(void))completion {
...
#pragma mark - UISidebarMenuViewControllerPanGestureRecognizer

#import <UIKit/UIGestureRecognizerSubclass.h>

@interface UISidebarMenuViewControllerPanGestureRecognizer : UIPanGestureRecognizer
@end

@implementation UISidebarMenuViewControllerPanGestureRecognizer {
    BOOL _dragging;
    CGPoint _beginPoint;
}
...
#pragma mark - UISidebarMenuViewController Class

@interface UISidebarMenuViewController()<UIGestureRecognizerDelegate> {
    UISidebarMenuView *_contentView;
...
@implementation UISidebarMenuViewController {
...
- (id)initWithRearViewController:(UIViewController *)rearViewController frontViewController:(UIViewController *)frontViewController; {
    ...
    if ( self ) {
        [self _initDefaultProperties];
        [self _performTransitionOperation:UISidebarMenuControllerOperationReplaceRearController withViewController:rearViewController animated:NO];
        [self _performTransitionOperation:UISidebarMenuControllerOperationReplaceFrontController withViewController:frontViewController animated:NO];
    }
    return self;
}
...
- (void)_initDefaultProperties {
    ...
    _toggleAnimationType = UISidebarMenuToggleAnimationTypeSpring;
...
- (void)loadView {
    ...
    _contentView = [[UISidebarMenuView alloc] initWithFrame:frame controller:self];
...
- (void)setFrontViewController:(UIViewController *)frontViewController animated:(BOOL)animated {
    ...
    [self _dispatchTransitionOperation:UISidebarMenuControllerOperationReplaceFrontController withViewController:frontViewController animated:animated];
}
...
- (void)setRearViewController:(UIViewController *)rearViewController animated:(BOOL)animated {
    ...
    [self _dispatchTransitionOperation:UISidebarMenuControllerOperationReplaceRearController withViewController:rearViewController animated:animated];
}
...
- (void)setRightViewController:(UIViewController *)rightViewController animated:(BOOL)animated {
    if ( ![self isViewLoaded]) {
        [self _performTransitionOperation:UISidebarMenuControllerOperationReplaceRightController withViewController:rightViewController animated:NO];
        return;
    }
    
    [self _dispatchTransitionOperation:UISidebarMenuControllerOperationReplaceRightController withViewController:rightViewController animated:animated];
}
...
- (UIPanGestureRecognizer*)panGestureRecognizer {
    ...
    {
        _panGestureRecognizer = [[UISidebarMenuViewControllerPanGestureRecognizer alloc] initWithTarget:self action:@selector(_handleRevealGesture:)];
...
- (void)_dispatchSetFrontViewPosition:(FrontViewPosition)frontViewPosition animated:(BOOL)animated {
    ...
    __weak UISidebarMenuViewController *theSelf = self;
...
- (void)_dispatchPushFrontViewController:(UIViewController *)newFrontViewController animated:(BOOL)animated {
    ...
    if ( animated ) {
        ...
        _enqueue( [theSelf _performTransitionOperation:UISidebarMenuControllerOperationReplaceFrontController withViewController:newFrontViewController animated:NO] );
...
- (void)_dispatchTransitionOperation:(UISidebarMenuControllerOperation)operation withViewController:(UIViewController *)newViewController animated:(BOOL)animated {
...
- (void)_setFrontViewPosition:(FrontViewPosition)newPosition withDuration:(NSTimeInterval)duration {
    ...
    if ( duration > 0.0 ) {
        if ( _toggleAnimationType == UISidebarMenuToggleAnimationTypeEaseOut ) {
...
//- (void)_performTransitionToViewController:(UIViewController*)new operation:(UISidebarMenuControllerOperation)operation animated:(BOOL)animated
- (void)_performTransitionOperation:(UISidebarMenuControllerOperation)operation withViewController:(UIViewController*)new animated:(BOOL)animated {
    ...
    if ( operation == UISidebarMenuControllerOperationReplaceRearController ) {
        old = _rearViewController, _rearViewController = new, view = _contentView.rearView;
    } else if ( operation == UISidebarMenuControllerOperationReplaceFrontController ) {
        old = _frontViewController, _frontViewController = new, view = _contentView.frontView;
    } else if ( operation == UISidebarMenuControllerOperationReplaceRightController ) {
...
+ (UIViewController *)viewControllerWithRestorationIdentifierPath:(NSArray *)identifierComponents coder:(NSCoder*)coder {
    UISidebarMenuViewController* vc = nil;
    UIStoryboard* sb = [coder decodeObjectForKey:UIStateRestorationViewControllerStoryboardKey];
    
    if (sb) {
        vc = (UISidebarMenuViewController*)[sb instantiateViewControllerWithIdentifier:@"UISidebarMenuViewController"];
        vc.restorationIdentifier = [identifierComponents lastObject];
        vc.restorationClass = [UISidebarMenuViewController class];
    }
    return vc;
}
...
#pragma mark - UIViewController(UISidebarMenuViewController) Category

@implementation UIViewController(UISidebarMenuViewController)

- (UISidebarMenuViewController*)revealViewController {
    UIViewController *parent = self;
    Class revealClass = [UISidebarMenuViewController class];
...
#pragma mark - UISidebarMenuViewControllerSegueSetController segue identifiers
...
#pragma mark - UISidebarMenuViewControllerSegueSetController class

@implementation UISidebarMenuViewControllerSegueSetController

- (void)perform {
    UISidebarMenuControllerOperation operation = UISidebarMenuControllerOperationNone;
    
    NSString *identifier = self.identifier;
    UISidebarMenuViewController *rvc = self.sourceViewController;
    UIViewController *dvc = self.destinationViewController;
    
    if ( [identifier isEqualToString:SWSegueFrontIdentifier] )
        operation = UISidebarMenuControllerOperationReplaceFrontController;
    
    else if ( [identifier isEqualToString:SWSegueRearIdentifier] )
        operation = UISidebarMenuControllerOperationReplaceRearController;
    
    else if ( [identifier isEqualToString:SWSegueRightIdentifier] )
        operation = UISidebarMenuControllerOperationReplaceRightController;
    
    if ( operation != UISidebarMenuControllerOperationNone )
...
#pragma mark - UISidebarMenuViewControllerSeguePushController class

@implementation UISidebarMenuViewControllerSeguePushController

- (void)perform {
    UISidebarMenuViewController *rvc = [self.sourceViewController revealViewController];
    UIViewController *dvc = self.destinationViewController;
